package net.jleto.minecraftplus.entity.custom;

import net.jleto.minecraftplus.entity.ModEntities;
import net.jleto.minecraftplus.entity.ai.HumanAttackGoal;
...
public class HumanEntity extends Animal {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new HumanAttackGoal(this, 1.0D, true));

        this.goalSelector.addGoal(1, new BreedGoal(this, 1.15D));
        this.goalSelector.addGoal(2, new TemptGoal(this, 1.20, Ingredient.of(ModItems.RUBY.get()), false));
    ...
    public AgeableMob getBreedOffspring(ServerLevel pLevel, AgeableMob pOtherParent) {
        return ModEntities.HUMAN.get().create(pLevel);
    }

    @Override
    public boolean isFood(ItemStack pStack) {
        return pStack.is(ModItems.RUBY.get());
    }
    ...
    protected SoundEvent getHurtSound(DamageSource pDamageSource) {
        return ModSounds.CLASSIC_HURT.get();
    }
